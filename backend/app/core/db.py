...
def _migrate_add_columns() -> None:
    ...
    migrations = [
        ...
        ("paper", "sci_zone", "TEXT DEFAULT ''"),
        ("paper", "impact_factor", "TEXT DEFAULT ''"),
        ("paper", "ccf_rank_override", "TEXT DEFAULT ''"),
        ("paper", "sci_zone_override", "TEXT DEFAULT ''"),
        ("paper", "impact_factor_override", "TEXT DEFAULT ''"),
        ...
        ("paper", "representative_image_path", "TEXT DEFAULT ''"),
        ("paper", "source_pdf_status", "TEXT DEFAULT 'available'"),
        ("paper", "spis_status", "TEXT DEFAULT ''"),
        ("paper", "spis_reason", "TEXT DEFAULT ''"),
        ("paper", "spis_last_attempt_at", "TIMESTAMP"),
        ("ingestion_item", "spis_status", "TEXT DEFAULT ''"),
        ("ingestion_item", "spis_reason", "TEXT DEFAULT ''"),
        ("ingestion_item", "spis_attempted_at", "TIMESTAMP"),
        ("paperblock", "asset_path", "TEXT DEFAULT ''"),
